...
static void runThis() {
    ...
    data.serverPort = 4891;
    char url2[] = {"opc.udp://224.0.0.22:4842/"};
    ...
    wg[0] = pub.addWriterGroup(6000, connId);//
    ...
    wg[2] = pub.addWriterGroup(6000, connId);//
    ...
    pub.addVariableToPublish(VAR_TYPE_FLOAT, wg[2], ID_FLOAT);
...
//    uInt64Val += 1000;
//    pub.writeValueToVariable(VAR_TYPE_DOUBLE, &doubleValue, ID_DOUBLE);
        ...
        for(int i = 0; i < dsm->data.keyFrameData.fieldCount; i++) {
            ...
            if(currentType == &UA_TYPES[UA_TYPES_BYTE]) {
                ...
                if(value){
                    ...
                    static UA_UInt64 uInt64Val = 0;
                    uInt64Val += 1000;
                    static UA_Float floatValue=0;
                    floatValue*=100;
                    // Change Value for Publish
                    pub.writeValueToVariable(VAR_TYPE_DOUBLE, &doubleValue, ID_DOUBLE);
                    pub.writeValueToVariable(&UA_TYPES[UA_TYPES_UINT64], &uInt64Val, UA_NODEID_NUMERIC(1, 5555));
                    pub.writeValueToVariable(VAR_TYPE_FLOAT,&floatValue,ID_FLOAT);
...
int main(int argc, char **argv) {
    ...
    char url[]="opc.udp://224.0.0.22:4841/";
